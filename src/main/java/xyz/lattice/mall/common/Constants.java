package xyz.lattice.mall.common;

public class Constants {
    public final static String FILE_UPLOAD_DIC = "/Users/lattice/Documents/fieldwork-projects/mall/src/main/resources/upload/";//上传文件的默认url前缀
